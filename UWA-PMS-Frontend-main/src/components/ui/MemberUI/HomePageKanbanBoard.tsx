...
const HomePageKanbanBoard: React.FC<KanbanBoardProps> = ({ projectId }) => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      const url = `${import.meta.env.VITE_BASE_URL}/api/member/tasks/task.php?action=list&id=${encodeURIComponent(projectId)}`;
  ...
  const updateTaskStatus = async (taskId: number, newStatus: LaneType) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}/api/member/tasks/task.php?action=update-status`,
        {
          method: 'POST',
          headers: {
  ...
  const handleSaveTask = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}/api/member/tasks/task.php?action=update`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
  ...
  const handleDeleteTask = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BASE_URL}/api/member/tasks/task.php?action=delete&project_id=${selectedTask.project_id}&id=${selectedTask.id}`,
        {
          method: 'DELETE',
          credentials: 'include',
        }
